...
exports.createSubSection=async(req,res)=>{
    try {
        ...
        // extract file file/video
        const video=req.files.videoFile
        //validation
        if(!sectionId||!title||!timeDuraion||!description){
            return res.status(400).json({
                success:false,
                message:"all fiels are require during creating subsection"
            })
        }
    ...
    const uploadDetails=await upleadImageToCloundnary(video , process.env.FOLDER_NAME)
        ...
        // insert this subsection into section
